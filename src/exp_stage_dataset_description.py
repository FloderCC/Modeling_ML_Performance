...
"""
# PYTHONPATH=/home/atnog/ML_Cost python3 /home/atnog/ML_Cost/src/exp_stage_dataset_description.py
...
from dataset_utils import describe_dataset_using_pymfe
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("log_exp_stage_dataset_description.log"),
...
for index, row in results_df.copy().iterrows():
    ...
    logging.info(f"Setup {training_number}/{number_of_tunings} done: {seed},{dataset_name},{dataset_percentage}. Desc time={toc-tic}")
    ...
    results_df.to_csv(f"results/results_stage_3.csv", index=False)
