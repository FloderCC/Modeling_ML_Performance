"""
Script to find a symbolic regression model for MCC inference based on dataset features when MCC > 0.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("log_sr_d_f.txt", mode='w'),
        GreenStreamHandler()
    ]
)
...
df_meta = df_meta.drop(columns=['Model', 'Model Type'])
